...
class TodoitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todoitem" do
    assert_difference('Todoitem.count') do
      post todoitems_url, params: { todoitem: { description: @todoitem.description, duedate: @todoitem.duedate } }
    end
  ...
  test "should update todoitem" do
    patch todoitem_url(@todoitem), params: { todoitem: { description: @todoitem.description, duedate: @todoitem.duedate } }
